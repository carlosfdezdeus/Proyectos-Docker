...
if((!empty( $_GET['model_id'])) && (!empty($_GET['logistic_id']))){
    ...
    echo '<div class="alert alert-danger">';
    echo '<strong>Error:</strong> ';
    echo ' El modelo o la logistica están selecionados';
    echo '</div>';
    exit();
}
...
function crear_tabla($array_equipos){
    ...
    foreach ($array_equipos as  $equipos) {
        ...
        <img src='/img/model_info/$nombre_imagen'>";
