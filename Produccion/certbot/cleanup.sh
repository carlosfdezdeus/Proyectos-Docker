...
curl "https://dinahosting.com/special/api.php?AUTH_USER=$USER&AUTH_PWD=$PASSWORD&domain=$DOMAIN&hostname=_acme-challenge.atc&command=Domain_Zone_DeleteTypeTXT"
